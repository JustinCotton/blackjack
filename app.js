...
const checkForPlayerBlackjack = (sum) => {
    if (sum == 21) {
        $("headline").text("BLACKJACK!").css("background", "red");
        $("#deal").show();
        $("#hit").hide();
        $("#stand").hide();
        $("#doubleDown").hide();
...
const checkForDealerBlackjack = (sum) => {
    if (sum == 21) {
        $("headline").text("Sorry! Dealer Has Blackjack!").css("background", "red");
        $("#deal").show();
        $("#hit").hide();
        $("#stand").hide();
        $("#doubleDown").hide();
...
const hitDealer = (hand) => {
    ...
    if (value > 21) {
        ...
        $("headline").text("PUSH! Player's Bet Refunded!").css("background", "red");
